...
public class JobExceptionHandler {
    ...
    public void handleAIException(String jobId, String commandType, AIServiceException e) {
        log.error("AI service exception - jobId: {}, commandType: {}", jobId, commandType, e);
    ...
    public void handleParseException(String jobId, String commandType, AIServiceException e) {
        log.error("Parse exception - jobId: {}, commandType: {}", jobId, commandType, e);
    ...
    public void handleRenderException(String jobId, String commandType, ContentRenderException e) {
        log.error("Render exception - jobId: {}, commandType: {}", jobId, commandType, e);
    ...
    public void handleStorageException(String jobId, String commandType, StorageException e) {
        log.error("Storage exception - jobId: {}, commandType: {}", jobId, commandType, e);
    ...
    public void handleRecoveryException(String jobId, String commandType, RecoveryException e) {
        log.error("Recovery exception - jobId: {}, commandType: {}", jobId, commandType, e);
