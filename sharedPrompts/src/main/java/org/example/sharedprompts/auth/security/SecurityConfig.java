...
import org.example.sharedprompts.auth.security.config.OAuth2Components;
import org.example.sharedprompts.auth.security.config.SecurityAuthorizationConfig;
import org.example.sharedprompts.auth.security.config.SecurityExceptionHandlers;
import org.example.sharedprompts.auth.security.config.SecurityFilterConfig;
import org.example.sharedprompts.auth.security.config.SecurityHeadersConfig;
