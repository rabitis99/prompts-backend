...
import org.example.sharedprompts.github.port.in.GenerateGitHubBodyUseCase;
...
public class GenerateBodyService implements GenerateGitHubBodyUseCase {
  ...
  private GithubBodyStorage mapToGithubBodyStorage(
      String tenantKey,
    ...
    return GithubBodyStorage.builder()
        .tenantKey(tenantKey)
