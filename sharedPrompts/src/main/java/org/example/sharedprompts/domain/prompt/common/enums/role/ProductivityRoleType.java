 ...
 * <ol>
 *   <li>stableKey - StableKeyedEnum용 고정 키 (예: ROLE.PRODUCTIVITY.PRODUCTIVITY_EXPERT)</li>
...
public enum ProductivityRoleType implements RoleTypeInterface, StableKeyedEnum {
    PRODUCTIVITY_EXPERT(
            "ROLE.PRODUCTIVITY.PRODUCTIVITY_EXPERT",
            "생산성 전문가",                    // roleNameKo
    ...
    TIME_MANAGEMENT_SPECIALIST(
            "ROLE.PRODUCTIVITY.TIME_MANAGEMENT_SPECIALIST",
    ...
    WORKFLOW_OPTIMIZER(
            "ROLE.PRODUCTIVITY.WORKFLOW_OPTIMIZER",
    ...
    AUTOMATION_SPECIALIST(
            "ROLE.PRODUCTIVITY.AUTOMATION_SPECIALIST",
            "자동화 전문가",                      // roleNameKo
    ...
    EFFICIENCY_CONSULTANT(
            "ROLE.PRODUCTIVITY.EFFICIENCY_CONSULTANT",
            "효율성 컨설턴트",                      // roleNameKo
