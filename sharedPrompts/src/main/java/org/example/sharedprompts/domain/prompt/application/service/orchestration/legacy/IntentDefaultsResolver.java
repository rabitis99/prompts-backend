...
/**
 * Intent defaults for legacy routing. Uses {@link IntentDictionary#getResolutionDefaults(ActionIntent)}
 * so resolution policy lives in the dictionary, not in the enum.
 */
@Component
