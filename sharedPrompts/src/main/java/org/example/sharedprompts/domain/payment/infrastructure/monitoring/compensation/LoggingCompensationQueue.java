...
public class LoggingCompensationQueue implements CompensationQueue {
    ...
    public void enqueue(CompensationTask task) {
        log.error("보상 트랜잭션 작업 큐에 추가: taskType={}, paymentId={}, userId={}, amount={}, originalAmount={}, failureReason={}, createdAt={}",
                task.taskType(), task.paymentId(), task.userId(), task.amount(), task.originalAmount(), task.failureReason(), task.createdAt());
