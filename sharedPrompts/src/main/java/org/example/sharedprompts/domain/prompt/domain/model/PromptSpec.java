 ...
 * {@link org.example.sharedprompts.domain.prompt.application.port.out.SavePromptVersionPort}가 담당한다.
 */
public final class PromptSpec {
    ...
    public ContentSandbox getContentSandbox() { return contentSandbox; }
    public RoleTypeInterface getRole() { return role; }
    public ToneType getTone() { return tone; }
    public StyleType getStyle() { return style; }
    public PromptStrategyBundle getStrategyBundle() { return strategyBundle; }
    public LanguageType getLocale() { return locale; }
    public String getRawInput() { return rawInput; }
    public String getClarifiedInput() { return clarifiedInput; }
    public ActionTypeInterface getActionType() { return actionType; }
