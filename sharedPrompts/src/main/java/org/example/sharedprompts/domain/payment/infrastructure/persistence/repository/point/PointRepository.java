package org.example.sharedprompts.domain.payment.infrastructure.persistence.repository.point;
...
public interface PointRepository extends JpaRepository<Point, Long>, CustomPointRepository {
    ...
    boolean existsByPaymentIdAndType(@Param("paymentId") Long paymentId, @Param("type") PointType type);
    ...
    boolean existsByPaymentIdAndUserIdAndType(@Param("paymentId") Long paymentId, @Param("userId") Long userId, @Param("type") PointType type);
}
