...
public enum CybersecurityActionType implements ActionTypeInterface, StableKeyedEnum {
    ...
    THREAT_ANALYSIS("위협 분석", "Threat Analysis", "脅威分析", OutputBehaviorType.ANALYTICAL_REPORT),
    ...
    SECURITY_POLICY("보안 정책", "Security Policy", "セキュリティポリシー", OutputBehaviorType.LONG_FORM_WRITING),
    ...
    RISK_ASSESSMENT_SECURITY("보안 위험 평가", "Security Risk Assessment", "セキュリティリスク評価", OutputBehaviorType.ANALYTICAL_REPORT),
    COMPLIANCE_MANAGEMENT("규정 준수 관리", "Compliance Management", "コンプライアンス管理", OutputBehaviorType.ANALYTICAL_REPORT),
