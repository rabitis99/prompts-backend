...
public enum ContentActionType implements ActionTypeInterface, StableKeyedEnum {
    ...
    SOCIAL_MEDIA_POST("소셜 미디어 게시물", "Social Media Post", "ソーシャルメディア投稿", OutputBehaviorType.SHORT_COPY),
    INSTAGRAM_CAPTION("인스타그램 캡션", "Instagram Caption", "Instagramキャプション", OutputBehaviorType.SHORT_COPY),
    FACEBOOK_POST("페이스북 게시물", "Facebook Post", "Facebook投稿", OutputBehaviorType.SHORT_COPY),
    X_POST("X 게시물", "X Post", "X投稿", OutputBehaviorType.SHORT_COPY),
    COMMENT_WRITING("댓글 작성", "Comment Writing", "コメント作成", OutputBehaviorType.SHORT_COPY),
