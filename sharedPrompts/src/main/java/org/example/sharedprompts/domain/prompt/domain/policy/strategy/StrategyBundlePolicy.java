...
public class StrategyBundlePolicy {
    ...
    private PromptStrategyBundle removeExperimentalStrategies(PromptStrategyBundle bundle, PromptObjective ignoredObjective) {
        ...
        experimental.forEach(filtered::remove);
