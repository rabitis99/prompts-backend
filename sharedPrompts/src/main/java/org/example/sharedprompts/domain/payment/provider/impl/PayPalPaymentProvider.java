...
import org.example.sharedprompts.domain.payment.provider.paypal.webhook.PayPalWebhookParser;
import org.example.sharedprompts.domain.payment.provider.paypal.webhook.PayPalWebhookVerifier;
...
public class PayPalPaymentProvider implements PaymentProvider {
    ...
    public boolean supportsIdempotency() {
        return true; // PayPal은 PayPal-Request-Id 헤더를 통한 멱등성 지원
    }
