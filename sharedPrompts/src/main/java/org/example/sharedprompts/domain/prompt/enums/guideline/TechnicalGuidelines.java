...
public final class TechnicalGuidelines implements GuidelinePolicy {
    ...
    public List<GuidelineRule> structuringRules() {
        return List.of(
                ...
                GuidelineRule.of(
                        "TECH.STRUCTURE.HIERARCHY",
                        I18nText.of("계층화", "Hierarchy", "階層化"),
                        I18nText.of(
                                "인사말, 서론, 마무리 생략",
