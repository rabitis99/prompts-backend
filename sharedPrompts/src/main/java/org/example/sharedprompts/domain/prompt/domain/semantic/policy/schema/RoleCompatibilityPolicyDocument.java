...
/**
 * Schema/DSL document for role compatibility policy (context → allowed/compatible role keys).
 * Reserved for future use; structure aligned with other policy families.
 */
public record RoleCompatibilityPolicyDocument(
    ...
    public static final String POLICY_TYPE = "RoleCompatibility";

    public RoleCompatibilityPolicyDocument {
