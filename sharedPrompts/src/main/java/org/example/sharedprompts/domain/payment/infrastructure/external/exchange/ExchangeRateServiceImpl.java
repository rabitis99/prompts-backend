...
import org.example.sharedprompts.domain.payment.infrastructure.persistence.adapter.ExchangeRateJpaAdapter;
...
public class ExchangeRateServiceImpl implements ExchangeRateService {
    ...
    private final ExchangeRateJpaAdapter exchangeRateJpaAdapter;
    ...
    public BigDecimal getExchangeRate(String fromCurrency, String toCurrency) {
        ...
        // 직접 환율 조회
        Optional<ExchangeRate> exchangeRateOpt = exchangeRateJpaAdapter.findByCurrencyPair(fromCurrency, toCurrency);
        ...
        Optional<ExchangeRate> reverseRateOpt = exchangeRateJpaAdapter.findByCurrencyPair(toCurrency, fromCurrency);
