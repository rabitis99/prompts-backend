...
public class SensitiveDataMasker {
     ...
     * <p>마스킹 규칙:
     * <ul>
     *   <li>@ 이전 부분: 앞 2자만 표시하고 나머지는 ***로 마스킹</li>
     *   <li>@ 이후 부분(도메인): 그대로 표시</li>
     *   <li>이메일이 너무 짧거나 형식이 잘못된 경우: 전체 마스킹</li>
     * </ul>
     * 
     * <p>예시:
     * <ul>
     *   <li>user@example.com -> us***@example.com</li>
     *   <li>test@domain.co.kr -> te***@domain.co.kr</li>
     *   <li>a@b.com -> ***@b.com</li>
     * </ul>
     * 
     ...
     * <p>마스킹 규칙:
     * <ul>
     *   <li>앞 2자리만 표시하고 나머지는 마스킹</li>
     *   <li>문자열이 너무 짧은 경우: 전체 마스킹</li>
     * </ul>
     * 
     * @param value 원본 문자열
